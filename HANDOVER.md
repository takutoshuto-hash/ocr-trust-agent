...
- **第5回 Agentic AI Hackathon with Google Cloud（Zenn）** への応募作品。締切 **2026-10-15 23:59**、**オフィスアワーは 9/29（火）**（公式スキルの schedule.md。以前この文書にあった 10/5 は誤り。LP で再確認すること）、ファイナリスト発表 10/28、最終ピッチ 12/1。
